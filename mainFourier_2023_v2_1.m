function mainFourier_2023_v2_1
...
Discarded variables (delete in v2_2):
% global brent_progression; 
% global tau_progression; 
% global u_progression; 
% toPlot = 1;
% saveEns = % data diagnostics switch % [not used]
% I := imaginary number i = sqrt(-1) % [not used]
%}
    ...
    VERBOSE = 1; 
    testcase = '_4096_optIC2048Cont0'; % " _[name] " % adjust prior to run
            ...
            for timept = 1:TimePoints % 
                ...
                switch VERBOSE
                    case 1 
                        ...
                        f_ens = time_evolution_and_optIC_save(Ntime,phi,timept,E0,lambda,T,N,uField,testcase,K0);

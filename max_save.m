function max_save(timept,lambda,E0,testcase_max,testcase_old)
    ...
    optIC_phys_file_old = [pwd '/data/spectrum/spectrum_E0_' num2str(E0)...
        '/optICphys' testcase_old '_E0(' num2str(E0) ')_Timept_'...
        num2str(timept) '_lambda(' num2str(lambda) ').dat'];
    optIC_four_file_old = [pwd '/data/spectrum/spectrum_E0_' num2str(E0)...
        '/optICfour' testcase_old '_E0(' num2str(E0) ')_Timept_'...
        num2str(timept) '_lambda(' num2str(lambda) ').dat'];
    optIC_fourfull_file_old = [pwd '/data/spectrum/spectrum_E0_' num2str(E0)...
        '/optICfourfull' testcase_old '_E0(' num2str(E0) ')_Timept_'...
        num2str(timept) '_lambda(' num2str(lambda) ').dat'];
    deriv_file_old = [pwd '/data/spectrum/spectrum_E0_' num2str(E0) '/deriv_optICphys'...
        testcase_old '_E0(' num2str(E0) ')_Timept_'...
        num2str(timept) '_lambda(' num2str(lambda) ').dat'];
    derivfdm_file_old = [pwd '/data/spectrum/spectrum_E0_' num2str(E0) '/derivfdm_optICphys'...
        testcase_old '_E0(' num2str(E0) ')_Timept_'...
        num2str(timept) '_lambda(' num2str(lambda) ').dat'];

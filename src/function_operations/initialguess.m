function solution = initialguess(type,x,E0,a1,x_ref,timept,testcase,lambda)     %
    ...
    switch type                                         %
        ...
        case '2 modes'                                                                      %
            ...
            solution = fft(solution);                                                       %
        case 'exact'                                                        %
            initialdata_file = [pwd '/data/optIC/LuLu_u_E010_nu3_N2048.dat'];    %
        ...
        case 'optIC'
            try                                                                             %
                phi_guess_file = [pwd '/data/optIC/phi' testcase '_E0(' num2str(E0) ').dat'];    %
                ...
                phi = initialguess('exact', x, E0, 0, x_ref,timept,testcase,lambda);     %
                solution = fft(phi);                                                            %
            end             %
    end
return
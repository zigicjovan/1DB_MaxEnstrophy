function main_1DBEnstrophy_2024_v4_4(ascent,caseID)

%{
[v4_4: modify stochastic variants: {'RSCG','RMSCG','RDSCG','RJSCG'}]
                        ...
                        while ( abs(J_step) > J_step_tol ) && ( ITER <= MAXITER )
                            ...
                            switch ascent
                                ...
                                case 'RMSCG'
                                    ...
                                    rand_gradJ = rand_gradJ + (3*sum(rand_w))*save_gradJ(ITER,:);
                                    rand_gradJ = rand_gradJ/(4*sum(rand_w)); 
                                case 'RDSCG'
                                    num = str2double(caseID);
